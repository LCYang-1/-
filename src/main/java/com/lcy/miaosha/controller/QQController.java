...
import com.lcy.miaosha.entity.Constants;
...
import com.lcy.miaosha.util.HttpClientUtils;
import com.lcy.miaosha.util.URLEncodeUtil;
...
public class QQController {
    ...
    public String getCode(HttpServletRequest request, HttpServletResponse response, HttpSession session, Model model) throws Exception {
        // 拼接url
...
//        }
        ...
        Long a=userService.ontSelectOfinsert(openId,userInfo);


        return "redirect:"+"http://localhost:8080/login/do_login?mobile="+a+"&password=d3b1294a61a07da9b49b6e22b2cbd7f9&ifyzm=1";
    }
